...
100: NEXT I
110: Q0=SUM1-SUM2
120: CLS: PRINT „zu Variationszyklen M“+ CHR$&D1 +“->“;: INPUT “ “; M: CLS: DIM PV(M)
130: FOR I=1 TO M
140: FOR J=1 TO NX
...
400: SW=0:LINE(70,31)-(70,0),X
410: FOR I=1 TO M-1
420: IF PV(I+1)<(PV(I)THEN D=PV(I:PV(I)=PV(I+1):PV(I+1)=D:SW=1
430: NEXT: IF SW=0 THEN GOTO 450
440: SW=0:GOTO 410
450: BR=168/M
460: FOR I=0 TO M-1
470: P=(PV(I+1)-PV(1))/(PV(M)-PV(1))
480: LINE(70+I*BR,31)-(70+(I+1)*BR,31-(P*31)),B
490: NEXT
500: LOCATE 0,0
510: WAIT: PRINT: END
