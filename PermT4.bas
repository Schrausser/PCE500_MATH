...
5:   REM *****************************************************
10:  CLEAR: CLS: PRINT „Permutationstest mP bzw. mPR via Bt“: PRINT „zur Matrix (X)=(x|g1|g2)“
20:  INPUT “n[11]->“; N1
30:  INPUT “n[12]->“; N2
40:  INPUT “n[21]->“; N3
50:  INPUT “n[22]->“; N4
60:  CLS: N=N1+N2+N3+N4: DIM A(N)
70:  FOR I=1 TO N1
...
220: CLS: PRINT „zu Variationszyklen M“+ CHR$&D1 +“->“;: INPUT “ “; M: CLS
230: FOR I=1 TO M
240: FOR J=1 TO N1
250: SUM1P=SUM1P+A(RND(N))
260: NEXT J
270: FOR J=1 TO N2
280: SUM2P=SUM2P+A(RND(N))
290: NEXT J
300: FOR J=1 TO N3
310: SUM3P=SUM3P+A(RND(N))
320: NEXT J
330: FOR J=1 TO N4
340: SUM4P=SUM4P+A(RND(N))
350: NEXT J
